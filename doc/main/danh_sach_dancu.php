          ...
          <div class="tile-body">
                              ...
                              <div class="col-12">
                                <span>
                                  <fieldset class="form-group" id="__BVID__1001">
                                    <legend tabindex="-1" class="bv-no-focus-ring col-form-label pt-0" id="__BVID__1001__BV_label_"> Địa chỉ email <span class="text-danger">(*)</span>
                                    </legend>
                                    <div>
                                      <div role="group" class="input-group">
                                        <!---->
                                        ...
                                        <input id="addressDetail" type="text" placeholder="hoten@gmail.com" class="form-control" name="email" required>
                                        <!---->
                                      </div>
                                      <small class="text-danger"></small>
                                      <!---->
            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <thead>
                ...
                <tr>
                  ...
                  <th width="100">Hộ chiếu/ CCCD</th>
                  <th width="120">Tên dân cư</th>
                  <th width="70">SĐT</th>
                  ...
                  $i=1;
                    ...
                    <tr>
                      ...
                      <td class="table-td-center">
                        <button class="btn btn-primary btn-sm trash" type="button" title="Xóa" id="btn-delete" data-id="<?php echo $row['id_dancu']  ?>"><i class="fas fa-trash-alt"></i>
                        </button>
                        <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="btn-edit"
                            data-toggle="modal" data-target="#ModalUP" data-id="<?php echo $row['id_dancu']?>"><i class="fas fa-edit"></i>
                          </button>
                      </a>
                      </td>
                    </tr> 
            ...
            <div class="modal fade bd-example-modal-lg" id="modal-default2">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Sửa dân cư</h4>
                    </div>
                    <form action="" method="post" enctype="multipart/form-data">
                      <div class="modal-body">
                          <input type="hidden" id="txtOrderId" value="0" />
                                  ...
                                  <fieldset class="form-group" id="__BVID__977">
                                    ...
                                    <div>
                                      <div role="group" class="input-group">
                                        ...
                                        <input id="tendancu2" type="text" placeholder="Nguyễn Văn A" class="form-control" name="tendancu2" required>
                                        <!---->
                                      </div>
                                      <br>
                                      <legend tabindex="-1" class="bv-no-focus-ring col-form-label pt-0" id="__BVID__977__BV_label_">Cccd/Hộ chiếu <span class="text-danger">(*)</span>
                                      ...
                                      <div role="group" class="input-group">
                                        ...
                                        <input id="cccd2" type="text" placeholder="Cccd/hộ chiếu" class="form-control" name="cccd2" required>
                                        <!---->
                                      </div>
                                      <small class="text-danger"></small>
                                      <!---->
                                  ...
                                  <fieldset class="form-group" id="__BVID__981">
                                    ...
                                    <div>
                                      <div dir="ltr" class="v-select vs--single vs--searchable" id="province">
                                        <div id="vs33__combobox" role="combobox" aria-expanded="false" aria-owns="vs33__listbox" aria-label="Search for option" class="vs__dropdown-toggle">
                                          <div class="vs__selected-options">
                                            <select name="gioitinh2" id="gioitinh2" aria-autocomplete="list" aria-labelledby="vs33__combobox" aria-controls="vs33__listbox" autocomplete="off" class="vs__search"  >
                                              <option value="">Giới tính</option>
                                  ...
                                  <fieldset class="form-group" id="__BVID__988">
                                    ...
                                    <div>
                                      <div dir="ltr" class="v-select vs--single vs--searchable vs--disabled" id="district">
                                        <div id="vs34__combobox" role="combobox" aria-expanded="false" aria-owns="vs34__listbox" aria-label="Search for option" class="" height="70%">
                                          <div class="vs__selected-options">
                                          <input id="sdt2" type="number" placeholder="0912345678" class="form-control" name="sdt2" required>
                                          </div>
                                  ...
                                  <fieldset class="form-group" id="__BVID__995">
                                    ...
                                    <div>
                                      <div dir="ltr" class="v-select vs--single vs--searchable vs--disabled" id="ward">
                                        <div id="vs35__combobox" role="combobox" aria-expanded="false" aria-owns="vs35__listbox" aria-label="Search for option" class="">
                                          <div class="vs__selected-options">
                                          <input id="ngaysinh2" type="date" class="form-control" name="ngaysinh2" required>
                                          </div>
                                        </div>
                                        <ul id="vs35__listbox" role="listbox" style="display: none; visibility: hidden;"></ul>
                                      </div>
                                  ...
                                  <fieldset class="form-group" id="__BVID__1001">
                                    ...
                                    <div>
                                      <div role="group" class="input-group">
                                        ...
                                        <input id="email2" type="text" placeholder="hoten@gmail.com" class="form-control" name="email2" required>
                                        <!---->
                                      </div>
                                      <small class="text-danger"></small>
                                      <!---->
                                  ...
                                  <fieldset class="form-group" id="__BVID__1001">
                                    ...
                                    <div>
                                      <div role="group" class="input-group">
                                        ...
                                        <input id="addressDetail2" type="text" placeholder="91 Nguyễn Chí Thanh" class="form-control" name="addressDetail2" required>
                                        <!---->
                                      </div>
                                      <small class="text-danger"></small>
                                      <!---->
                                  ...
                                  <fieldset class="form-group" id="__BVID__977">
                                    ...
                                    <div>
                                      <div role="group" class="input-group">
                                        ...
                                        <input id="file_img2" type="file" placeholder="10" class="form-control" name="file_img2" >
...
<script>
    $(document).ready(function () {
        ...
        $('body').on('click', '#btn-edit', function () { 
            ...
            $.ajax({
                url: "./doc/main/commons/lay_dan_cu.php", 
                type: "post",
                dataType: "html",          
                data: { iddancu: id },
              }).done(function(toanha){
                var decodedData = JSON.parse(decodeURIComponent(toanha));
                $('#tendancu2').val(decodedData.ho_ten)
                $('#cccd2').val(decodedData.cccd)
                $('#sdt2').val(decodedData.sdt)
                $('#gioitinh2').val(decodedData.gioi_tinh)
               
                $('#ngaysinh2').val(decodedData.ngay_sinh)
                $('#email2').val(decodedData.email)
                $('#file_info').text(decodedData.hinh_anh)
